  ...
  return (
    <div className="flex-[2] border-r-2 border-gray-500 bg-[#e4e4e5] dark:bg-[#061728]">
      ...
      <div className="flex  flex-col gap-2 border-b-2 border-gray-500 px-8 py-4">
        <div className="flex dark:bg-gray-800 bg-white font-semibold p-2 justify-between items-center rounded-lg ">
        ...
        <div className="flex-col p-5 rounded-md dark:bg-gray-600 bg-white">
                  ...
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        ...
                        >
                          <div className="dark:bg-gray-800 text-black mt-5 border border-gray-600 flex flex-row justify-start mb-5 items-center my-1 py-1.5 px-2 text-sm rounded">
                            <img
                              src={
                                profileImg
                            ...
                            />
                            <span
                              className="dark:text-gray-100 text-xs mx-5 cursor-pointer"
                              onClick={() => imageRef.current.click()}
                            >
                              Change Profile
                            </span>
